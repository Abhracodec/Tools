import pprint
#print("fucks".join(['cat','fat','rat']))
script = """# Exploit Title: WordPress Backup Migration 1.3.7 - Remote Command Execution
# Date: 2025-10-26
# Exploit Author: DANG
...
pprint.pprint(script[69])
print(script[69].strip(".py"))